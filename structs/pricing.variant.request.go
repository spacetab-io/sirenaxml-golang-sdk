...
type PricingVariantRequest struct {
	Query   PricingVariantRequestQuery `xml:"query"`
	XMLName xml.Name                   `xml:"sirena"`
}

// PricingRouteRequestQuery is a <query> section in <pricing_route> request
type PricingVariantRequestQuery struct {
	PricingRoute PricingVariant `xml:"pricing_route"`
}

// PricingRoute is a <pricing_route> section
type PricingVariant struct {
	Segments      []PricingVariantRequestSegment   `xml:"segment"`
	Passenger     []PricingVariantRequestPassenger `xml:"passenger"`
	RequestParams PricingVariantRequestParams      `xml:"request_params"`
	AnswerParams  PricingVariantAnswerParams       `xml:"answer_params"`
}

// PricingRouteRequestSegment is a <segment> section in <pricing_route> request
type PricingVariantRequestSegment struct {
...
type PricingVariantRequestPassenger struct {
...
type PricingVariantRequestParams struct {
...
type PricingVariantAnswerParams struct {
...
type PricingVariantRequestFormpay struct {
